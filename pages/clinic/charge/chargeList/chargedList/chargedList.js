...
Component({
  ...
  data: {
    ...
    isHideBottomView: false,//是否隐藏底部上拉加载框
  ...
  methods: {
    ...
    onChargedListCell(e) {
      ...
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clickchargedcell', myEventDetail, myEventOption)
    },
    /**
     * 开始刷新数据
     */
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      chargeJs.loadPayedDataListData(this.data.keyword, this.data.page, this.data.rows,
