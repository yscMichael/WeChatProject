...
const app = getApp();
//网络请求
var patientJs = require('../../../../../api/patientRequest/patientRequest.js');
...
Component({
  ...
  methods: {
     ...
     * 点击cell
     */
    onClickPatientCell(e) {
      //detail对象，提供给事件监听函数
      var myEventDetail = {}
      //触发事件的选项
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clickAllPatient', myEventDetail, myEventOption);
    },
    /**
     * 开始刷新数据
     */
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      patientJs.loadPatientListData(this.data.keyword, this.data.page, this.data.rows,
