...
const app = getApp();
//网络请求
var sendJs = require('../../../../../api/sendRequest/sendRequest.js');
...
Component({
  ...
  methods: {
    ...
    onClickSendingListCell(e) {
      ...
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clicksendingcell', myEventDetail, myEventOption)
    },
    /**
     * 开始刷新数据
     */
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      sendJs.loadUnSendDataListData(this.data.keyword, this.data.page, this.data.rows,
