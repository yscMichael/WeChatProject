...
Component({
  ...
  methods: {
    ...
    onChineseDrugListCell(e) {
      ...
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clickchinesecell', myEventDetail, myEventOption)
    },
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      initJs.downloadDrugListRequest(3, this.data.page,
