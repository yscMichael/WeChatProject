...
Component({
  ...
  methods: {
    ...
    onInstrumentListCell(e) {
      ...
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clickinstrumentcell', myEventDetail, myEventOption)
    },
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      initJs.downloadDrugListRequest(4, this.data.page,
