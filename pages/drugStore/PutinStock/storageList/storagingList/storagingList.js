...
Component({
  ...
  methods: {
    ...
    onStoragingListCell(e) {
      ...
      var myEventOption = {}
      //设置外界监听
      this.triggerEvent('clickstoragingcell', myEventDetail, myEventOption)
    },
    ...
    _loadData: function () {
      //1、网络请求、加载数据
      var that = this;
      drugJs.getStoragingData(this.data.page, function (success, totalCount){
        //总数赋值
